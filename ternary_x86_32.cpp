...
namespace ternarylogic {
    ...
    namespace x86_32 {
        ...
        template<unsigned k> __forceinline constexpr uint32_t ternary(const uint32_t, const uint32_t, const uint32_t) {
        ...
        template<> __forceinline constexpr uint32_t ternary<0x01>(const uint32_t A, const uint32_t B, const uint32_t C) {
        ...
        template<> __forceinline constexpr uint32_t ternary<0x02>(const uint32_t A, const uint32_t B, const uint32_t C) {
        ...
        template<> __forceinline constexpr uint32_t ternary<0x04>(const uint32_t A, const uint32_t B, const uint32_t C) {
        ...
        template<> __forceinline constexpr uint32_t ternary<0x06>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~A;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x07>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B & C;
            const uint32_t t1 = A | t0;
            const uint32_t t2 = ~t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x08>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~A;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x09>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B ^ C;
            const uint32_t t1 = A | t0;
            const uint32_t t2 = ~t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x0b>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~A;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x0d>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~A;
            const uint32_t c1 = uint32_t(-1);
        ...
        template<> __forceinline constexpr uint32_t ternary<0x0e>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~A;
            const uint32_t t1 = B | C;
            const uint32_t t2 = t0 & t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x10>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B | C;
            const uint32_t t1 = ~t0;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x12>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~B;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x13>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A & C;
            const uint32_t t1 = B | t0;
            const uint32_t t2 = ~t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x14>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~C;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x15>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B & A;
            const uint32_t t1 = C | t0;
            const uint32_t t2 = ~t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x16>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B | C;
            const uint32_t t1 = ~t0;
            const uint32_t t2 = A & t1;
            const uint32_t t3 = ~A;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x17>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B | C;
            const uint32_t t1 = B & C;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x18>(const uint32_t A, const uint32_t B, const uint32_t C) {
        ...
        template<> __forceinline constexpr uint32_t ternary<0x19>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B ^ C;
            const uint32_t t1 = B & C;
            const uint32_t t2 = A & t1;
            const uint32_t t3 = t0 ^ t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x1a>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A & B;
            const uint32_t t1 = ~t0;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x1b>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~A;
            const uint32_t t1 = C & t0;
            const uint32_t t2 = ~C;
            const uint32_t t3 = ~B;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x1c>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A & C;
            const uint32_t t1 = ~t0;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x1d>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~A;
            const uint32_t t1 = B & t0;
            const uint32_t t2 = ~B;
            const uint32_t t3 = ~C;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x1e>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B | C;
            const uint32_t t1 = A ^ t0;
            return t1;
        }
        // code=0x1f, function=(A nand (B or C)), lowered=not ((A and (B or C))), set=intel
        template<> __forceinline constexpr uint32_t ternary<0x1f>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B | C;
            const uint32_t t1 = A & t0;
            const uint32_t t2 = ~t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x20>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~B;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x21>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A ^ C;
            const uint32_t t1 = B | t0;
            const uint32_t t2 = ~t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x23>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~B;
            const uint32_t c1 = uint32_t(-1);
        ...
        template<> __forceinline constexpr uint32_t ternary<0x24>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A ^ B;
            const uint32_t t1 = B ^ C;
            const uint32_t t2 = t0 & t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x25>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A & B;
            const uint32_t t1 = ~t0;
            const uint32_t c1 = uint32_t(-1);
        ...
        template<> __forceinline constexpr uint32_t ternary<0x26>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A & B;
            const uint32_t t1 = ~t0;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x27>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~B;
            const uint32_t t1 = C & t0;
            const uint32_t t2 = ~C;
            const uint32_t t3 = ~A;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x28>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B ^ A;
            const uint32_t t1 = C & t0;
            return t1;
        }
        // code=0x29, function=(C ? (B xor A) : (B nor A)), lowered=((C and (B xor A)) or (not (C) and not ((B or A)))), set=intel
        template<> __forceinline constexpr uint32_t ternary<0x29>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B ^ A;
            const uint32_t t1 = C & t0;
            const uint32_t t2 = ~C;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x2a>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B & A;
            const uint32_t t1 = ~t0;
            const uint32_t t2 = C & t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x2b>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B & A;
            const uint32_t t1 = ~t0;
            const uint32_t t2 = C & t1;
            const uint32_t t3 = ~C;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x2c>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B | C;
            const uint32_t t1 = A ^ B;
            const uint32_t t2 = t0 & t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x2d>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~C;
            const uint32_t t1 = B | t0;
            const uint32_t t2 = A ^ t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x2e>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B | C;
            const uint32_t t1 = A & B;
            const uint32_t t2 = t0 ^ t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x2f>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~A;
            const uint32_t t1 = ~B;
            const uint32_t t2 = t1 & C;
            const uint32_t t3 = t0 | t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x31>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~B;
            const uint32_t c1 = uint32_t(-1);
            const uint32_t t1 = C ^ c1;
            const uint32_t t2 = A | t1;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x32>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~B;
            const uint32_t t1 = A | C;
            const uint32_t t2 = t0 & t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x34>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B & C;
            const uint32_t t1 = ~t0;
            const uint32_t t2 = A ^ B;
            const uint32_t t3 = t1 & t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x35>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~B;
            const uint32_t t1 = A & t0;
            const uint32_t t2 = ~A;
            const uint32_t t3 = ~C;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x36>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A | C;
            const uint32_t t1 = B ^ t0;
            return t1;
        }
        // code=0x37, function=(B nand (A or C)), lowered=not ((B and (A or C))), set=intel
        template<> __forceinline constexpr uint32_t ternary<0x37>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A | C;
            const uint32_t t1 = B & t0;
            const uint32_t t2 = ~t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x38>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A | C;
            const uint32_t t1 = A ^ B;
            const uint32_t t2 = t0 & t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x39>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t c1 = uint32_t(-1);
        ...
        template<> __forceinline constexpr uint32_t ternary<0x3a>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~B;
            const uint32_t t1 = A & t0;
            const uint32_t t2 = ~A;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x3b>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~A;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x3d>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A ^ B;
            const uint32_t t1 = A | C;
            const uint32_t t2 = ~t1;
            const uint32_t t3 = t0 | t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x3e>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~A;
            const uint32_t t1 = t0 & C;
            const uint32_t t2 = A ^ B;
            const uint32_t t3 = t1 | t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x40>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~C;
            const uint32_t t1 = t0 & A;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x41>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B ^ A;
            const uint32_t t1 = C | t0;
            const uint32_t t2 = ~t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x42>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A ^ C;
            const uint32_t t1 = B ^ C;
            const uint32_t t2 = t0 & t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x43>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A & C;
            const uint32_t t1 = ~t0;
            const uint32_t c1 = uint32_t(-1);
            const uint32_t t2 = B ^ c1;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x45>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~C;
            const uint32_t c1 = uint32_t(-1);
            const uint32_t t1 = A ^ c1;
            const uint32_t t2 = t1 | B;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x46>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A & C;
            const uint32_t t1 = ~t0;
            const uint32_t t2 = B ^ C;
            const uint32_t t3 = t1 & t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x47>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~C;
            const uint32_t t1 = B & t0;
            const uint32_t t2 = ~B;
            const uint32_t t3 = ~A;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x48>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A ^ C;
            const uint32_t t1 = B & t0;
            return t1;
        }
        // code=0x49, function=(B ? (A xor C) : (A nor C)), lowered=((B and (A xor C)) or (not (B) and not ((A or C)))), set=intel
        template<> __forceinline constexpr uint32_t ternary<0x49>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A ^ C;
            const uint32_t t1 = B & t0;
            const uint32_t t2 = ~B;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x4a>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B | C;
            const uint32_t t1 = A ^ C;
            const uint32_t t2 = t0 & t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x4b>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~B;
            const uint32_t t1 = t0 | C;
            const uint32_t t2 = A ^ t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x4c>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A & C;
            const uint32_t t1 = ~t0;
            const uint32_t t2 = B & t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x4d>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A & C;
            const uint32_t t1 = ~t0;
            const uint32_t t2 = B & t1;
            const uint32_t t3 = ~B;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x4e>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~A;
            const uint32_t t1 = C & t0;
            const uint32_t t2 = ~C;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x4f>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~A;
            const uint32_t t1 = ~C;
            const uint32_t t2 = B & t1;
            const uint32_t t3 = t0 | t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x51>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~C;
            const uint32_t c1 = uint32_t(-1);
            const uint32_t t1 = B ^ c1;
            const uint32_t t2 = A | t1;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x52>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B & C;
            const uint32_t t1 = ~t0;
            const uint32_t t2 = A ^ C;
            const uint32_t t3 = t1 & t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x53>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~C;
            const uint32_t t1 = A & t0;
            const uint32_t t2 = ~A;
            const uint32_t t3 = ~B;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x54>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~C;
            const uint32_t t1 = A | B;
            const uint32_t t2 = t0 & t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x56>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B | A;
            const uint32_t t1 = C ^ t0;
            return t1;
        }
        // code=0x57, function=(C nand (B or A)), lowered=not ((C and (B or A))), set=intel
        template<> __forceinline constexpr uint32_t ternary<0x57>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B | A;
            const uint32_t t1 = C & t0;
            const uint32_t t2 = ~t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x58>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A | B;
            const uint32_t t1 = A ^ C;
            const uint32_t t2 = t0 & t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x59>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t c1 = uint32_t(-1);
        ...
        template<> __forceinline constexpr uint32_t ternary<0x5b>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A ^ C;
            const uint32_t t1 = A | B;
            const uint32_t c1 = uint32_t(-1);
        ...
        template<> __forceinline constexpr uint32_t ternary<0x5c>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~C;
            const uint32_t t1 = A & t0;
            const uint32_t t2 = ~A;
            const uint32_t t3 = t2 & B;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x5d>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~C;
            const uint32_t t1 = ~A;
            const uint32_t t2 = t1 & B;
            const uint32_t t3 = t0 | t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x5e>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~C;
            const uint32_t t1 = t0 & B;
            const uint32_t t2 = A ^ C;
            const uint32_t t3 = t1 | t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x60>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B ^ C;
            const uint32_t t1 = A & t0;
            return t1;
        }
        // code=0x61, function=(A ? (B xor C) : (B nor C)), lowered=((A and (B xor C)) or (not (A) and not ((B or C)))), set=intel
        template<> __forceinline constexpr uint32_t ternary<0x61>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B ^ C;
            const uint32_t t1 = A & t0;
            const uint32_t t2 = ~A;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x62>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A | C;
            const uint32_t t1 = B ^ C;
            const uint32_t t2 = t0 & t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x63>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t c1 = uint32_t(-1);
        ...
        template<> __forceinline constexpr uint32_t ternary<0x64>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A | B;
            const uint32_t t1 = B ^ C;
            const uint32_t t2 = t0 & t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x65>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t c1 = uint32_t(-1);
            const uint32_t t0 = A ^ c1;
            const uint32_t t1 = t0 | B;
            const uint32_t t2 = C ^ t1;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x67>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B ^ C;
            const uint32_t t1 = A | B;
            const uint32_t t2 = ~t1;
            const uint32_t t3 = t0 | t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x68>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B ^ C;
            const uint32_t t1 = A & t0;
            const uint32_t t2 = ~A;
            const uint32_t t3 = B & C;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x69>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B ^ C;
            const uint32_t t1 = A ^ t0;
            const uint32_t t2 = ~t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x6a>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B & A;
            const uint32_t t1 = C ^ t0;
            return t1;
        }
        // code=0x6b, function=((not (A) and C) or ((A xor 1) xor (B xor C))), lowered=((not (A) and C) or ((A xor 1) xor (B xor C))), set=automat
        template<> __forceinline constexpr uint32_t ternary<0x6b>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~A;
            const uint32_t t1 = t0 & C;
            const uint32_t c1 = uint32_t(-1);
        ...
        template<> __forceinline constexpr uint32_t ternary<0x6c>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A & C;
            const uint32_t t1 = B ^ t0;
            return t1;
        }
        // code=0x6d, function=((not (A) and B) or ((A xor 1) xor (B xor C))), lowered=((not (A) and B) or ((A xor 1) xor (B xor C))), set=automat
        template<> __forceinline constexpr uint32_t ternary<0x6d>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~A;
            const uint32_t t1 = t0 & B;
            const uint32_t c1 = uint32_t(-1);
            const uint32_t t2 = A ^ c1;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x6e>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~A;
            const uint32_t t1 = t0 & B;
            const uint32_t t2 = B ^ C;
            const uint32_t t3 = t1 | t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x6f>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B ^ C;
            const uint32_t c1 = uint32_t(-1);
            const uint32_t t1 = A ^ c1;
            const uint32_t t2 = t0 | t1;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x70>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B & C;
            const uint32_t t1 = ~t0;
            const uint32_t t2 = A & t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x71>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B | C;
            const uint32_t t1 = ~t0;
            const uint32_t t2 = B ^ C;
            const uint32_t t3 = A & t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x72>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~B;
            const uint32_t t1 = C & t0;
            const uint32_t t2 = ~C;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x73>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~B;
            const uint32_t t1 = ~C;
            const uint32_t t2 = A & t1;
            const uint32_t t3 = t0 | t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x74>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~C;
            const uint32_t t1 = B & t0;
            const uint32_t t2 = ~B;
            const uint32_t t3 = t2 & A;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x75>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~C;
            const uint32_t t1 = ~B;
            const uint32_t t2 = A & t1;
            const uint32_t t3 = t0 | t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x76>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~B;
            const uint32_t t1 = t0 & A;
            const uint32_t t2 = B ^ C;
            const uint32_t t3 = t1 | t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x78>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B & C;
            const uint32_t t1 = A ^ t0;
            return t1;
        }
        // code=0x79, function=((not (B) and A) or ((B xor 1) xor (A xor C))), lowered=((not (B) and A) or ((B xor 1) xor (A xor C))), set=automat
        template<> __forceinline constexpr uint32_t ternary<0x79>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~B;
            const uint32_t t1 = t0 & A;
            const uint32_t c1 = uint32_t(-1);
            const uint32_t t2 = B ^ c1;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x7a>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~B;
            const uint32_t t1 = t0 & A;
            const uint32_t t2 = A ^ C;
            const uint32_t t3 = t1 | t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x7b>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~B;
            const uint32_t t1 = A ^ C;
            const uint32_t t2 = t0 | t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x7c>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~C;
            const uint32_t t1 = t0 & A;
            const uint32_t t2 = A ^ B;
            const uint32_t t3 = t1 | t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x7d>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A ^ B;
            const uint32_t c1 = uint32_t(-1);
            const uint32_t t1 = C ^ c1;
            const uint32_t t2 = t0 | t1;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x7e>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A ^ B;
            const uint32_t t1 = A ^ C;
            const uint32_t t2 = t0 | t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x7f>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A & B;
            const uint32_t t1 = t0 & C;
            const uint32_t c1 = uint32_t(-1);
            const uint32_t t2 = t1 ^ c1;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x80>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B & C;
            const uint32_t t1 = A & t0;
            return t1;
        }
        // code=0x81, function=(not ((A xor C)) and (A xor (B xor 1))), lowered=(not ((A xor C)) and (A xor (B xor 1))), set=automat
        template<> __forceinline constexpr uint32_t ternary<0x81>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A ^ C;
            const uint32_t t1 = ~t0;
            const uint32_t c1 = uint32_t(-1);
            const uint32_t t2 = B ^ c1;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x82>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B ^ A;
            const uint32_t t1 = ~t0;
            const uint32_t t2 = C & t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x83>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A ^ B;
            const uint32_t t1 = ~t0;
            const uint32_t c1 = uint32_t(-1);
            const uint32_t t2 = A ^ c1;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x84>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A ^ C;
            const uint32_t t1 = ~t0;
            const uint32_t t2 = B & t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x85>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A ^ C;
            const uint32_t t1 = ~t0;
            const uint32_t c1 = uint32_t(-1);
            const uint32_t t2 = C ^ c1;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x86>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B | C;
            const uint32_t t1 = A ^ B;
            const uint32_t t2 = C ^ t1;
            const uint32_t t3 = t0 & t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x87>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B & C;
            const uint32_t t1 = A ^ t0;
            const uint32_t t2 = ~t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x89>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B ^ C;
            const uint32_t t1 = ~t0;
            const uint32_t c1 = uint32_t(-1);
            const uint32_t t2 = A ^ c1;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x8a>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~B;
            const uint32_t t1 = t0 & A;
            const uint32_t t2 = ~t1;
            const uint32_t t3 = t2 & C;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x8b>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B & C;
            const uint32_t t1 = ~B;
            const uint32_t t2 = ~A;
            const uint32_t t3 = t1 & t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x8c>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~C;
            const uint32_t t1 = t0 & A;
            const uint32_t t2 = ~t1;
            const uint32_t t3 = t2 & B;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x8d>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = C & B;
            const uint32_t t1 = ~C;
            const uint32_t t2 = ~A;
            const uint32_t t3 = t1 & t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x8e>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B & C;
            const uint32_t t1 = ~A;
            const uint32_t t2 = B ^ C;
            const uint32_t t3 = t1 & t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x8f>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~A;
            const uint32_t t1 = B & C;
            const uint32_t t2 = t0 | t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x90>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B ^ C;
            const uint32_t t1 = ~t0;
            const uint32_t t2 = A & t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x91>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B ^ C;
            const uint32_t t1 = ~t0;
            const uint32_t c1 = uint32_t(-1);
            const uint32_t t2 = B ^ c1;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x92>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A | C;
            const uint32_t t1 = A ^ B;
            const uint32_t t2 = C ^ t1;
            const uint32_t t3 = t0 & t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x93>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A & C;
            const uint32_t t1 = B ^ t0;
            const uint32_t t2 = ~t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x94>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A | B;
            const uint32_t t1 = A ^ C;
            const uint32_t t2 = B ^ t1;
            const uint32_t t3 = t0 & t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x95>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B & A;
            const uint32_t t1 = C ^ t0;
            const uint32_t t2 = ~t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x96>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B ^ C;
            const uint32_t t1 = A ^ t0;
            return t1;
        }
        // code=0x97, function=(A ? (B xnor C) : (B nand C)), lowered=((A and not ((B xor C))) or (not (A) and not ((B and C)))), set=intel
        template<> __forceinline constexpr uint32_t ternary<0x97>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B ^ C;
            const uint32_t t1 = ~t0;
            const uint32_t t2 = A & t1;
            const uint32_t t3 = ~A;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x98>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B ^ C;
            const uint32_t t1 = ~t0;
            const uint32_t t2 = A | B;
            const uint32_t t3 = t1 & t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x9a>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~B;
            const uint32_t t1 = t0 & A;
            const uint32_t t2 = t1 ^ C;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x9b>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~A;
            const uint32_t t1 = t0 & C;
            const uint32_t c1 = uint32_t(-1);
            const uint32_t t2 = C ^ c1;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x9c>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~C;
            const uint32_t t1 = t0 & A;
            const uint32_t t2 = t1 ^ B;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x9d>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~A;
            const uint32_t t1 = t0 & B;
            const uint32_t c1 = uint32_t(-1);
            const uint32_t t2 = C ^ c1;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x9e>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B & C;
            const uint32_t t1 = A ^ B;
            const uint32_t t2 = C ^ t1;
            const uint32_t t3 = t0 | t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0x9f>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B ^ C;
            const uint32_t t1 = A & t0;
            const uint32_t t2 = ~t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xa1>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A ^ C;
            const uint32_t t1 = ~t0;
            const uint32_t c1 = uint32_t(-1);
            const uint32_t t2 = B ^ c1;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xa2>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~B;
            const uint32_t t1 = A | t0;
            const uint32_t t2 = C & t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xa3>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A & C;
            const uint32_t t1 = ~A;
            const uint32_t t2 = ~B;
            const uint32_t t3 = t1 & t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xa4>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A ^ C;
            const uint32_t t1 = ~t0;
            const uint32_t t2 = A | B;
            const uint32_t t3 = t1 & t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xa6>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~A;
            const uint32_t t1 = t0 & B;
            const uint32_t t2 = t1 ^ C;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xa7>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~B;
            const uint32_t t1 = t0 & C;
            const uint32_t c1 = uint32_t(-1);
            const uint32_t t2 = C ^ c1;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xa8>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A | B;
            const uint32_t t1 = C & t0;
            return t1;
        }
        // code=0xa9, function=(C xnor (B or A)), lowered=not ((C xor (B or A))), set=intel
        template<> __forceinline constexpr uint32_t ternary<0xa9>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B | A;
            const uint32_t t1 = C ^ t0;
            const uint32_t t2 = ~t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xab>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B | A;
            const uint32_t t1 = ~t0;
            const uint32_t t2 = C | t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xac>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A & C;
            const uint32_t t1 = ~A;
            const uint32_t t2 = t1 & B;
            const uint32_t t3 = t0 | t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xad>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B & C;
            const uint32_t c1 = uint32_t(-1);
            const uint32_t t1 = C ^ c1;
            const uint32_t t2 = A ^ t1;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xae>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~A;
            const uint32_t t1 = t0 & B;
            const uint32_t t2 = t1 | C;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xb0>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~C;
            const uint32_t t1 = t0 & B;
            const uint32_t t2 = ~t1;
            const uint32_t t3 = t2 & A;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xb1>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = C & A;
            const uint32_t t1 = ~C;
            const uint32_t t2 = ~B;
            const uint32_t t3 = t1 & t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xb2>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A & C;
            const uint32_t t1 = B & t0;
            const uint32_t t2 = ~B;
            const uint32_t t3 = A | C;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xb3>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~B;
            const uint32_t t1 = A & C;
            const uint32_t t2 = t0 | t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xb4>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~C;
            const uint32_t t1 = t0 & B;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xb5>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~B;
            const uint32_t t1 = t0 & A;
            const uint32_t c1 = uint32_t(-1);
            const uint32_t t2 = C ^ c1;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xb6>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A & C;
            const uint32_t t1 = A ^ B;
            const uint32_t t2 = C ^ t1;
            const uint32_t t3 = t0 | t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xb7>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A ^ C;
            const uint32_t t1 = B & t0;
            const uint32_t t2 = ~t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xb8>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B & C;
            const uint32_t t1 = ~B;
            const uint32_t t2 = t1 & A;
            const uint32_t t3 = t0 | t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xb9>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A & C;
            const uint32_t c1 = uint32_t(-1);
            const uint32_t t1 = C ^ c1;
            const uint32_t t2 = B ^ t1;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xba>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~B;
            const uint32_t t1 = t0 & A;
            const uint32_t t2 = t1 | C;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xbc>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A & C;
            const uint32_t t1 = A ^ B;
            const uint32_t t2 = t0 | t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xbd>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A ^ B;
            const uint32_t c1 = uint32_t(-1);
            const uint32_t t1 = C ^ c1;
            const uint32_t t2 = A ^ t1;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xbe>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B ^ A;
            const uint32_t t1 = C | t0;
            return t1;
        }
        // code=0xbf, function=(C or (B nand A)), lowered=(C or not ((B and A))), set=intel
        template<> __forceinline constexpr uint32_t ternary<0xbf>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B & A;
            const uint32_t t1 = ~t0;
            const uint32_t t2 = C | t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xc1>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A ^ B;
            const uint32_t t1 = ~t0;
            const uint32_t c1 = uint32_t(-1);
            const uint32_t t2 = C ^ c1;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xc2>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A ^ B;
            const uint32_t t1 = ~t0;
            const uint32_t t2 = A | C;
            const uint32_t t3 = t1 & t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xc4>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~A;
            const uint32_t t1 = t0 & C;
            const uint32_t t2 = ~t1;
            const uint32_t t3 = t2 & B;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xc5>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A & B;
            const uint32_t t1 = ~A;
            const uint32_t t2 = ~C;
            const uint32_t t3 = t1 & t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xc6>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~A;
            const uint32_t t1 = t0 & C;
            const uint32_t t2 = t1 ^ B;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xc7>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~C;
            const uint32_t t1 = t0 & B;
            const uint32_t c1 = uint32_t(-1);
            const uint32_t t2 = B ^ c1;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xc8>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A | C;
            const uint32_t t1 = B & t0;
            return t1;
        }
        // code=0xc9, function=(B xnor (A or C)), lowered=not ((B xor (A or C))), set=intel
        template<> __forceinline constexpr uint32_t ternary<0xc9>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A | C;
            const uint32_t t1 = B ^ t0;
            const uint32_t t2 = ~t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xca>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A & B;
            const uint32_t t1 = ~A;
            const uint32_t t2 = t1 & C;
            const uint32_t t3 = t0 | t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xcb>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B & C;
            const uint32_t c1 = uint32_t(-1);
            const uint32_t t1 = B ^ c1;
            const uint32_t t2 = A ^ t1;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xcd>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A | C;
            const uint32_t t1 = ~t0;
            const uint32_t t2 = B | t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xce>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~A;
            const uint32_t t1 = t0 & C;
            const uint32_t t2 = t1 | B;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xd0>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~C;
            const uint32_t t1 = B | t0;
            const uint32_t t2 = A & t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xd1>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B | C;
            const uint32_t t1 = ~t0;
            const uint32_t t2 = A & B;
            const uint32_t t3 = t1 | t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xd2>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~B;
            const uint32_t t1 = t0 & C;
            const uint32_t t2 = t1 ^ A;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xd3>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~C;
            const uint32_t t1 = t0 & A;
            const uint32_t c1 = uint32_t(-1);
            const uint32_t t2 = B ^ c1;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xd4>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~C;
            const uint32_t t1 = B & t0;
            const uint32_t t2 = B ^ C;
            const uint32_t t3 = ~t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xd5>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~C;
            const uint32_t t1 = A & B;
            const uint32_t t2 = t0 | t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xd6>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A & B;
            const uint32_t t1 = A ^ C;
            const uint32_t t2 = B ^ t1;
            const uint32_t t3 = t0 | t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xd7>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B ^ A;
            const uint32_t t1 = C & t0;
            const uint32_t t2 = ~t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xd8>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = C & B;
            const uint32_t t1 = ~C;
            const uint32_t t2 = t1 & A;
            const uint32_t t3 = t0 | t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xd9>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B ^ C;
            const uint32_t t1 = ~t0;
            const uint32_t t2 = A & B;
            const uint32_t t3 = t1 | t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xda>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A & B;
            const uint32_t t1 = A ^ C;
            const uint32_t t2 = t0 | t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xdb>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A ^ C;
            const uint32_t c1 = uint32_t(-1);
            const uint32_t t1 = B ^ c1;
            const uint32_t t2 = A ^ t1;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xdc>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~C;
            const uint32_t t1 = t0 & A;
            const uint32_t t2 = t1 | B;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xde>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A ^ C;
            const uint32_t t1 = B | t0;
            return t1;
        }
        // code=0xdf, function=(B or (A nand C)), lowered=(B or not ((A and C))), set=intel
        template<> __forceinline constexpr uint32_t ternary<0xdf>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A & C;
            const uint32_t t1 = ~t0;
            const uint32_t t2 = B | t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xe0>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B | C;
            const uint32_t t1 = A & t0;
            return t1;
        }
        // code=0xe1, function=(A xnor (B or C)), lowered=not ((A xor (B or C))), set=intel
        template<> __forceinline constexpr uint32_t ternary<0xe1>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B | C;
            const uint32_t t1 = A ^ t0;
            const uint32_t t2 = ~t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xe2>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B & A;
            const uint32_t t1 = ~B;
            const uint32_t t2 = t1 & C;
            const uint32_t t3 = t0 | t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xe3>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A & C;
            const uint32_t c1 = uint32_t(-1);
            const uint32_t t1 = B ^ c1;
            const uint32_t t2 = A ^ t1;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xe4>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = C & A;
            const uint32_t t1 = ~C;
            const uint32_t t2 = t1 & B;
            const uint32_t t3 = t0 | t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xe5>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A & B;
            const uint32_t c1 = uint32_t(-1);
            const uint32_t t1 = C ^ c1;
            const uint32_t t2 = A ^ t1;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xe6>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A & B;
            const uint32_t t1 = B ^ C;
            const uint32_t t2 = t0 | t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xe7>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B ^ C;
            const uint32_t t1 = ~A;
            const uint32_t t2 = t1 ^ C;
            const uint32_t t3 = t0 | t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xe8>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B & C;
            const uint32_t t1 = B ^ C;
            const uint32_t t2 = A & t1;
            const uint32_t t3 = t0 | t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xe9>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~A;
            const uint32_t t1 = B ^ C;
            const uint32_t t2 = t0 ^ t1;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xea>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B & A;
            const uint32_t t1 = C | t0;
            return t1;
        }
        // code=0xeb, function=(C or (B xnor A)), lowered=(C or not ((B xor A))), set=intel
        template<> __forceinline constexpr uint32_t ternary<0xeb>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B ^ A;
            const uint32_t t1 = ~t0;
            const uint32_t t2 = C | t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xec>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A & C;
            const uint32_t t1 = B | t0;
            return t1;
        }
        // code=0xed, function=(B or (A xnor C)), lowered=(B or not ((A xor C))), set=intel
        template<> __forceinline constexpr uint32_t ternary<0xed>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = A ^ C;
            const uint32_t t1 = ~t0;
            const uint32_t t2 = B | t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xef>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~A;
            const uint32_t t1 = B | C;
            const uint32_t t2 = t0 | t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xf1>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B | C;
            const uint32_t t1 = ~t0;
            const uint32_t t2 = A | t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xf2>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~B;
            const uint32_t t1 = t0 & C;
            const uint32_t t2 = t1 | A;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xf4>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~C;
            const uint32_t t1 = t0 & B;
            const uint32_t t2 = t1 | A;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xf6>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B ^ C;
            const uint32_t t1 = A | t0;
            return t1;
        }
        // code=0xf7, function=(A or (B nand C)), lowered=(A or not ((B and C))), set=intel
        template<> __forceinline constexpr uint32_t ternary<0xf7>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B & C;
            const uint32_t t1 = ~t0;
            const uint32_t t2 = A | t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xf8>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B & C;
            const uint32_t t1 = A | t0;
            return t1;
        }
        // code=0xf9, function=(A or (B xnor C)), lowered=(A or not ((B xor C))), set=intel
        template<> __forceinline constexpr uint32_t ternary<0xf9>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B ^ C;
            const uint32_t t1 = ~t0;
            const uint32_t t2 = A | t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xfb>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~B;
            const uint32_t t1 = t0 | C;
            const uint32_t t2 = A | t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xfd>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = ~C;
            const uint32_t t1 = A | B;
            const uint32_t t2 = t0 | t1;
            return t2;
        ...
        template<> __forceinline constexpr uint32_t ternary<0xfe>(const uint32_t A, const uint32_t B, const uint32_t C) {
            const uint32_t t0 = B | C;
            const uint32_t t1 = A | t0;
            return t1;
        }
